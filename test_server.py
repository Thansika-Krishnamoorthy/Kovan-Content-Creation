...
class PosterApiTests(unittest.TestCase):
    ...
    def test_model_prompt_uses_visual_direction_not_brand_spec_text(self):
        ...
        self.assertIn("The exact selected official logo is added after generation", html)
        self.assertIn("abstract geometric mark", html)
        self.assertIn("applyExternalPosterLogo", html)
        self.assertIn('id="externalPoster"', html)
